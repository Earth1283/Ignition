...
import org.dreeam.leaf.command.subcommands.PredictorCommand;
...
public final class LeafCommand extends Command {
    ...
    private static final LeafSubcommand PREDICTOR_SUBCOMMAND = new PredictorCommand();
    private static final Map<String, LeafSubcommand> SUBCOMMANDS = Util.make(() -> {
        ...
        commands.put(Set.of(PredictorCommand.LITERAL_ARGUMENT), PREDICTOR_SUBCOMMAND);
